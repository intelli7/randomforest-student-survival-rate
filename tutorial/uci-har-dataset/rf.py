...
x = pd.read_csv("train/X_train.txt", header=None, delim_whitespace=True, index_col=False)
y = pd.read_csv("train/y_train.txt", header=None, delim_whitespace=True, index_col=False)
